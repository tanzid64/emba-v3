...
<body>
    ...
    <h1 class="title">Executive MBA Program — Viva Shortlist</h1>
    ...
    <div class="summary">
        Eligible for viva: {{ number_format($eligibleCount) }}
        &nbsp;|&nbsp;
        MCQ cutoff: {{ rtrim(rtrim(number_format($threshold, 2), '0'), '.') }} / {{ config('result.max_mcq_marks') }}
    </div>
            ...
            @empty
                <tr>
                    <td colspan="8" class="center" style="padding:14px; color:#6B7280;">
                        No candidates have reached the MCQ cutoff yet.
                    </td>
                </tr>
            @endforelse
        </tbody>
