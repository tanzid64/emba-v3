    ...
    <section class="min-h-[calc(100vh-128px)] flex items-center justify-center py-12 px-4" style="background:#f4f4f8;">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <p class="text-xs font-bold uppercase tracking-widest mb-2" style="color:#8b072b;">Password Reset</p>
                <h1 class="font-inter font-bold text-2xl sm:text-3xl text-gray-900">Set a new password</h1>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form method="POST" action="{{ route('applicant.password.update') }}" class="space-y-5">
                    @csrf
